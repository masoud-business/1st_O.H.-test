...
data class OversightItemEntity(
    ...
    val isDeleted: Boolean = false, // مکانیزم Soft-Delete جهت حفظ سوابق، لاگ‌ها و پرمیت‌ها در پایگاه داده
...
/**
 * 13. صف همگام‌سازی ابری و آفلاین (Local-First Cloud Sync Queue)
 * مدیریت ارسال تراکنش‌های ثبت‌شده در کارگاه به سرور مرکزی یا Supabase/Firebase
 */
@Entity(
    tableName = "sync_queue",
    indices = [Index("syncStatus"), Index("entityType")]
)
data class SyncQueueEntity(
    @PrimaryKey(autoGenerate = true)
    val id: Long = 0,
    val entityType: String, // "wbs_item", "daily_log", "safety_permit", "procurement", "digital_signature"
    val entityId: Long,
